...
describe('Calculate the fee amount', () => {
  test('two minutes duration should pay 3.00', () => {
    expect(
      paymentCalculator({
  ...
  test('one hour duration should pay 3.00', () => {
    expect(
      paymentCalculator({
        checkInDate: checkInDate,
  ...
  test('three hours duration should pay 4.50', () => {
    expect(
      paymentCalculator({
        checkInDate: checkInDate,
  ...
  test('five hours and five minutes duration duration should pay 6.75', () => {
    expect(
      paymentCalculator({
        checkInDate: checkInDate,
  ...
  test('one day duration duration should pay 10.13', () => {
    expect(
      paymentCalculator({
        checkInDate: checkInDate,
