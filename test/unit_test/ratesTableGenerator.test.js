...
describe('Generate array of rates', () => {
  test('Generate rates table for 1hr, 3hr, 6hr and ALL DAY rates with an increment of 50% for each rate level and 3.00 as the base price', () =>
    expect(
      ratesTableGenerator({
        rateTimes: rateTimes,
        rateNames: rateNames,
